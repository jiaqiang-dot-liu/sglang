...
class SchedulerOutputStreamer:
    ...
    def _stream_output_generation(
        ...
        # One pass rather than four any() scans: this runs per decode step on the
        # scheduler's critical path, called synchronously from
        ...
        for req in reqs:
            ...
            if (
                ...
                and return_indexer_topk
                and return_sampling_mask
            ):
                break
